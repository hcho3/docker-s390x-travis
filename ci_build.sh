...
#
# Usage: ci_build.sh <DOCKERFILE_PATH> <DOCKER_IMG_NAME> [-it] <COMMAND>
#
# DOCKERFILE_PATH: Path to the Dockerfile used for docker build
...
if [ "$#" -lt 1 ]
then
    echo "Usage: $(basename $0) DOCKERFILE_PATH DOCKER_IMG_NAME COMMAND"
    exit 1
fi
